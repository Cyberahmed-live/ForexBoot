...
def calculate_sl_tp(price, direction, stop_loss_pips, take_profit_pips, symbol):
    ...
    min_stop_level = symbol_info.trade_stops_level * 2  # minimalny odstęp w punktach
    ...
    required_sl_distance = max(stop_loss_pips * point, min_stop_distance) + (point * 15)  # dodajemy dodatkowy margines
