...
global_cfg = {
    ...
    "symbols": ['AUDUSD', 'AUDCAD', 'AUDCHF', 'AUDJPY', 'AUDNZD', 'EURUSD', 'EURCHF', 'EURJPY', 'EURPLN', 'GBPUSD', 'GBPJPY', 'GBPCAD', 'GBPCHF', 'CHFPLN', 'USDJPY', 'USDCHF', 'USDCAD', 'USDPLN', 'NZDUSD', 'XAUUSD', 'XAGUSD'],  # Capital.com demo
